...
const workoutDB = [
    ...
    { 
        ...
        steps: [
            "Setup: Approach a squat rack and duck under the barbell. Position the bar securely across the meaty, upper part of your trapezius muscles (high-bar) or slightly lower on the rear delts (low-bar). Grip the bar tightly, stand up to unrack it, and take one or two deliberate steps backward.", 
            "Stance: Set your feet roughly shoulder-width apart. Your toes should be pointing slightly outward (about 15 to 30 degrees). Keep your chest up proudly, look straight ahead, and take a deep breath into your belly to brace your core.", 
            ...
            "The Ascent: Maintain your upright chest. Drive forcefully through the middle of your feet and your heels, pushing the floor away to stand back up. Exhale as you power through the hardest part of the upward movement, returning to the starting position."
        ] 
    },
    { 
    ...
    { 
        ...
        steps: [
            ...
            "Grip: Hold an EZ curl bar resting in front of your thighs. Use a pronated (overhand, palms facing down) grip on the outer angled portions of the bar.", 
    ...
    // ================= CARDIO (Top 20 Populer dengan fokus panduan detail) =================
    { 
